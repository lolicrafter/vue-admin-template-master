  ...
  <div class="content-container">
    <div class="main-content">
      <div class="action-container flexBetween">
        <div class="left">
          <el-button>设备异常反馈记录</el-button>
          <el-button>设备绑定码</el-button>
        </div>
        <div class="right flexStart">
          <div class="search-item">
            <el-select :value="searchForm.project" placeholder="固件升级状态" @change="handleRoleChange">
              <el-option
          ...
          <div class="search-item">
            <el-select :value="searchForm.project" placeholder="工作状态" @change="handleRoleChange">
              <el-option
                v-for="item in projectOptions"
                :key="item.value"
                :label="item.label"
          ...
          <div class="search-item">
            <el-select :value="searchForm.join" placeholder="请选择项目" @change="handleRoleChange">
              <el-option
                v-for="item in projectOptions"
                :key="item.value"
                :label="item.label"
      ...
      <div class="table-container">
        <el-table :data="tableData">
          ...
          <el-table-column prop="name" label="固件升级"/>
          <el-table-column prop="name" label="工作状态"/>
